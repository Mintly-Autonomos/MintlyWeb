    ...
    history: [
      {
        ...
        by: 'Marina Souza',
        action: 'Conta criada',
        detail: `Tipo: ${TYPE_META[type].label}`,
        icon: 'add_circle',
      },
    ],
    ...extra,
...
const INITIAL: Account[] = [
  ...
  mkAccount(4, 'iFood', 'Financial Platform', true, false, 3475.6, 5120.0, {
    taxPct: 12,
    settlementDays: 14,
  }),
  mkAccount(5, 'Rappi', 'Financial Platform', false, false, 0, 0, {
    taxPct: 18,
    settlementDays: 21,
  }),
  mkAccount(6, 'Cartão Stone', 'Financial Platform', false, false, 0, 0, {
    taxPct: 15,
    settlementDays: 30,
  }),
];
        ...
        history: [
          {
            ...
            action: 'Conta criada',
            detail: `Tipo: ${TYPE_META[account.type].label}`,
            icon: 'add_circle',
          },
        ],
      },
